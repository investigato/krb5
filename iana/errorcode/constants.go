...
const (
	// No error.
	KDC_ERR_NONE int32 = 0

	// Client's entry in database has expired.
	KDC_ERR_NAME_EXP int32 = 1

	// Server's entry in database has expired.
	KDC_ERR_SERVICE_EXP int32 = 2

	// Requested protocol version number not supported.
	KDC_ERR_BAD_PVNO int32 = 3

	// Client's key encrypted in old master key.
	KDC_ERR_C_OLD_MAST_KVNO int32 = 4

	// Server's key encrypted in old master key.
	KDC_ERR_S_OLD_MAST_KVNO int32 = 5
	...
	KDC_ERR_PRINCIPAL_NOT_UNIQUE int32 = 8

	// The client or server has a null key.
	KDC_ERR_NULL_KEY int32 = 9

	// Ticket not eligible for  postdating.
	KDC_ERR_CANNOT_POSTDATE int32 = 10

	// Requested starttime is later than end time.
	KDC_ERR_NEVER_VALID int32 = 11

	// KDC policy rejects request.
	KDC_ERR_POLICY int32 = 12

	// KDC cannot accommodate requested option.
	KDC_ERR_BADOPTION int32 = 13

	// KDC has no support for  encryption type.
	KDC_ERR_ETYPE_NOSUPP int32 = 14

	// KDC has no support for  checksum type.
	KDC_ERR_SUMTYPE_NOSUPP int32 = 15

	// KDC has no support for  padata type.
	KDC_ERR_PADATA_TYPE_NOSUPP int32 = 16

	// KDC has no support for  transited type.
	KDC_ERR_TRTYPE_NOSUPP int32 = 17

	// Clients credentials have been revoked.
	KDC_ERR_CLIENT_REVOKED int32 = 18

	// Credentials for server have been revoked.
	KDC_ERR_SERVICE_REVOKED int32 = 19

	// TGT has been revoked.
	KDC_ERR_TGT_REVOKED int32 = 20

	// Client not yet valid; try again later.
	KDC_ERR_CLIENT_NOTYET int32 = 21

	// Server not yet valid; try again later.
	KDC_ERR_SERVICE_NOTYET int32 = 22

	// Password has expired; change password to reset.
	KDC_ERR_KEY_EXPIRED int32 = 23
	...
	KDC_ERR_SERVER_NOMATCH int32 = 26

	// Server principal valid for  user2user only.
	KDC_ERR_MUST_USE_USER2USER int32 = 27

	// KDC Policy rejects transited path.
	KDC_ERR_PATH_NOT_ACCEPTED int32 = 28

	// A service is not available.
	KDC_ERR_SVC_UNAVAILABLE int32 = 29
	...
	// Request is a replay.
	KRB_AP_ERR_REPEAT int32 = 34

	// The ticket isn't for us.
	KRB_AP_ERR_NOT_US int32 = 35
	...
	KRB_AP_ERR_BADADDR int32 = 38

	// Protocol version mismatch.
	KRB_AP_ERR_BADVERSION int32 = 39

	// Invalid msg type.
	KRB_AP_ERR_MSG_TYPE int32 = 40

	// Message stream modified.
	KRB_AP_ERR_MODIFIED int32 = 41

	// Message out of order.
	KRB_AP_ERR_BADORDER int32 = 42

	// Specified version of key is not available.
	KRB_AP_ERR_BADKEYVER int32 = 44

	// Service key not available.
	KRB_AP_ERR_NOKEY int32 = 45

	// Mutual authentication failed.
	KRB_AP_ERR_MUT_FAIL int32 = 46

	// Incorrect message direction.
	KRB_AP_ERR_BADDIRECTION int32 = 47

	// Alternative authentication method required.
	KRB_AP_ERR_METHOD int32 = 48

	// Incorrect sequence number in message.
	KRB_AP_ERR_BADSEQ int32 = 49

	// Inappropriate type of checksum in message.
	KRB_AP_ERR_INAPP_CKSUM int32 = 50

	// Policy rejects transited path.
	KRB_AP_PATH_NOT_ACCEPTED int32 = 51

	// Response too big for UDP;  retry with TCP.
	KRB_ERR_RESPONSE_TOO_BIG int32 = 52

	// Generic error (description in e-text).
	KRB_ERR_GENERIC int32 = 60

	// Field is too long for this implementation.
	KRB_ERR_FIELD_TOOLONG int32 = 61

	// Reserved for PKINIT.
	KDC_ERROR_CLIENT_NOT_TRUSTED int32 = 62

	// Reserved for PKINIT.
	KDC_ERROR_KDC_NOT_TRUSTED int32 = 63

	// Reserved for PKINIT.
	KDC_ERROR_INVALID_SIG int32 = 64

	// Reserved for PKINIT.
	KDC_ERR_KEY_TOO_WEAK int32 = 65

	// Reserved for PKINIT.
	KDC_ERR_CERTIFICATE_MISMATCH int32 = 66

	// No TGT available to validate USER-TO-USER.
	KRB_AP_ERR_NO_TGT int32 = 67

	// Reserved for future use.
	KDC_ERR_WRONG_REALM int32 = 68

	// Ticket must be for  USER-TO-USER.
	KRB_AP_ERR_USER_TO_USER_REQUIRED int32 = 69

	// Reserved for PKINIT.
	KDC_ERR_CANT_VERIFY_CERTIFICATE int32 = 70

	// Reserved for PKINIT.
	KDC_ERR_INVALID_CERTIFICATE int32 = 71

	// Reserved for PKINIT.
	KDC_ERR_REVOKED_CERTIFICATE int32 = 72

	// Reserved for PKINIT.
	KDC_ERR_REVOCATION_STATUS_UNKNOWN int32 = 73

	// Reserved for PKINIT.
	KDC_ERR_REVOCATION_STATUS_UNAVAILABLE int32 = 74

	// Reserved for PKINIT.
	KDC_ERR_CLIENT_NAME_MISMATCH int32 = 75

	// Reserved for PKINIT.
	KDC_ERR_KDC_NAME_MISMATCH int32 = 76
)
